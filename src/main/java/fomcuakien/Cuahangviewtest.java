...
import sevicecuakien.CuaHangServicetest;
 ...
 * @author PC
 */
public class Cuahangviewtest extends javax.swing.JFrame {

   private CuaHangServicetest cuahangServicetest = new CuaHangServicetest();
    DefaultTableModel model = new DefaultTableModel();

    /**
     * Creates new form ChucVuViewtest
     */
    public Cuahangviewtest() {
        initComponents();
        
        this.setDefaultCloseOperation(Cuahangviewtest.DO_NOTHING_ON_CLOSE);
    ...
    public void loadTB() {
        ...
        List<ViewModelCuaHang> cvt = cuahangServicetest .getAll();
        List<ViewModelCuaHang> cv = cuahangServicetest .getAll();

        for (ViewModelCuaHang viewModelChucVu : cv) {
    ...
    public void loadTBCVTimKiem(String ten) {
        ...
        List<ViewModelCuaHang> cv =  cuahangServicetest .getListSPByName(ten);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        cv.setTenCuaHang(txtTen.getText());

        if (checkTen()) {
            boolean b =  cuahangServicetest .add(cv);
            if (b == true) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (checkTen()) {
            boolean b = cuahangServicetest.update(cv);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
         CuaHang cv = new CuaHang();
        cv.setId(txtId.getText());
        boolean b = cuahangServicetest.delete(cv);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuahangviewtest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cuahangviewtest().setVisible(true);
            }
        });
    }
