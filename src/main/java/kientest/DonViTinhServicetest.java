 ...
 * @author Admin
 */
public class DonViTinhServicetest implements IManageDonViTinhService {
    ...
    public static void main(String[] args) {
         DonViTinhServicetest dvtrp = new DonViTinhServicetest();
    ...
    public List<ViewModelDonViTinh> getAll() {
